        ...
        if (this.f === this.anim.endFrame)
        {
            switch (this.motion)
            {
                case 'walk':
                    ...
                    scene.time.delayedCall(delay * delayMultiple, this.changeFrame, [], this);
                    break;

                case 'attack':
                    delay = Math.random() * 2;
                    scene.time.delayedCall(delay * delayMultiple, this.resetAnimation, [], this);
                    break;
...
export default class Example extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        this.cameras.main.setSize(this.cameras.main.width, this.cameras.main.height);
